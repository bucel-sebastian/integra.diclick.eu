...
if($fileActualExt==="pdf"){
    ...
    $sql = "INSERT INTO `anexe`(`unicId`, `file`, `client`, `perioada_start`, `perioada_sfarsit`, `observatii`) VALUES ('$contractId','$file','$client','$perStart','$perSfarsit','$observatii')";
