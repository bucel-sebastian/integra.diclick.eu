...
$sql = "INSERT INTO `$clientId`(`projectId`, `projectStatus`, `startDate`, `endDate`, `name`, `description`, `projectType`) VALUES ('$projectId', '$status', '$startDate', '', '$title', '$description', '$projectType')";
...
if($result){
    ...
    if($result2){
        if($projectType==="0"){
            $notifText="New project added - ".$projectName." - type - Custom";
            ...
            $result=mysqli_query($tasksConn,$sql);
            if($result){
                $notifText="New project added - ".$projectName." - type - Campanie cu premii";
                $notifDate=date("Y-m-d H:i:s");
                $sql="INSERT INTO `admin_notifications`(`date`, `text`, `client`, `status`) VALUES ('$notifDate','$notifText','$notifClient','1')";
                if(mysqli_query($conn,$sql)){
                    echo "success";
            ...
            $result=mysqli_query($tasksConn,$sql);
            if($result){
                $notifText="New project added - ".$projectName." - type - Website development";
                $notifDate=date("Y-m-d H:i:s");
                $sql="INSERT INTO `admin_notifications`(`date`, `text`, `client`, `status`) VALUES ('$notifDate','$notifText','$notifClient','1')";
                if(mysqli_query($conn,$sql)){
                    echo "success";
            ...
            $result=mysqli_query($tasksConn,$sql);
            if($result){
                $notifText="New project added - ".$projectName." - type - Materiale comunicare";
                $notifDate=date("Y-m-d H:i:s");
                $sql="INSERT INTO `admin_notifications`(`date`, `text`, `client`, `status`) VALUES ('$notifDate','$notifText','$notifClient','1')";
                if(mysqli_query($conn,$sql)){
                    echo "success";
            ...
            $result=mysqli_query($tasksConn,$sql);
            if($result){
                $notifText="New project added - ".$projectName." - type - Activare BTL";
                $notifDate=date("Y-m-d H:i:s");
                $sql="INSERT INTO `admin_notifications`(`date`, `text`, `client`, `status`) VALUES ('$notifDate','$notifText','$notifClient','1')";
                if(mysqli_query($conn,$sql)){
                    echo "success";
            ...
            $result=mysqli_query($tasksConn,$sql);
            if($result){
                $notifText="New project added - ".$projectName." - type - Campanie de performance marketing";
                $notifDate=date("Y-m-d H:i:s");
                $sql="INSERT INTO `admin_notifications`(`date`, `text`, `client`, `status`) VALUES ('$notifDate','$notifText','$notifClient','1')";
                if(mysqli_query($conn,$sql)){
                    echo "success";
            ...
            $result=mysqli_query($tasksConn,$sql);
            if($result){
                $notifText="New project added - ".$projectName." - type - Activare on-line";
                $notifDate=date("Y-m-d H:i:s");
                $sql="INSERT INTO `admin_notifications`(`date`, `text`, `client`, `status`) VALUES ('$notifDate','$notifText','$notifClient','1')";
                if(mysqli_query($conn,$sql)){
                    echo "success";
            ...
            $result=mysqli_query($tasksConn,$sql);
            if($result){
                $notifText="New project added - ".$projectName." - type - Platforma on-line";
                $notifDate=date("Y-m-d H:i:s");
                $sql="INSERT INTO `admin_notifications`(`date`, `text`, `client`, `status`) VALUES ('$notifDate','$notifText','$notifClient','1')";
                if(mysqli_query($conn,$sql)){
                    echo "success";
